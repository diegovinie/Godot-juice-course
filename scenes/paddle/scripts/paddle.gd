...
var max_lean_angle: float = 7.0
var lean_speed: float = 8.0

# Oscilator
var displacement: float = 0.0
var oscilator_velocity: float = 0.0
...
func _process(delta: float) -> void:
	...
	oscilator_velocity += (velocity.x / speed) * velocity_multiplier
	
	var force = -spring * displacement + damp * oscilator_velocity
	oscilator_velocity -= force * delta
	displacement -= oscilator_velocity * delta
